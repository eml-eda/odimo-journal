...
layer_3 = {'o_x': 16, 'o_y': 16, 'c_in': 128, 'c_out': torch.tensor(128), 'k_x': 1, 'k_y': 1, 'groups': 1}
cost_pw += cost_darkside(layer_3).item()

layer5 = {'o_x': 8, 'o_y': 8, 'c_in': 256, 'c_out': torch.tensor(256), 'k_x': 1, 'k_y': 1, 'groups': 1}
cost_pw += cost_darkside(layer5).item()

layer7 = {'o_x': 4, 'o_y': 4, 'c_in': 512, 'c_out': torch.tensor(512), 'k_x': 1, 'k_y': 1, 'groups': 1}
cost_pw += (cost_darkside(layer7).item()) * 5

layer13 = {'o_x': 2, 'o_y': 2, 'c_in': 1024, 'c_out': torch.tensor(1024), 'k_x': 1, 'k_y': 1, 'groups': 1}
